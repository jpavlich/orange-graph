...
type_map: Dict[str, str] = {
    ...
    "a directed graph": "nx.DiGraph",
    "a directed acyclic graph": "nx.DiGraph",
    "node in g": "Any",
    ...
    "the networkx graph used to construct the numpy matrix": "nx.Graph",
    ...
    "the graph to be analyzed": "nx.Graph",
    ...
    "networkx graph object": "nx.Graph",
    ...
    "all nodes in the graph": "Iterable",
    ...
    "the connected graph math g": "nx.Graph",
    ...
    "graphs and multigraphs": "nx.Graph",
    ...
    "if true traverse a directed graph in the reverse direction": "bool",
    ...
    "this function returns a directed graph": "nx.DiGraph",
    ...
    "the constructed undirected multigraph": "nx.MultiGraph",
    "a set containing the maximal cliques in g": "Any",
    "the size of the largest clique in the graph minus one": "int",
    "the number of vertices the generated graph is to contain": "int",
    ...
    "a strongly-connected graph": "nx.Graph",
    ...
    "nodes in the graph": "Iterable",
    "iterator of common neighbors of u and v in the graph": "Iterator",
    "as the value": "Any",
    ...
    "return graph of this type": "nx.Graph",
